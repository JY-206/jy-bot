//-----(jy-bot by JY Bot Inc.)-----\\
//-----(Youtube Channel: JY)-----\\
//-----(Whatsapp number: +51957947127)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*jy-bot*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/G3a3AQndqS5J45eD7zznXF', "groupName": `JY Bot Inc.`, "footerText": "*jy-bot *", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "jy-bot"; break;
                case 1: jamss = "jy-bot"; break;
                case 2: jamss = "jy-bot"; break;
                case 3: jamss = "jy-bot"; break;
                case 4: jamss = "jy-bot"; break;
                case 5: jamss = "jy-bot"; break;
                case 6: jamss = "jy-bot"; break;
                case 7: jamss = "jy-bot"; break;
                case 8: jamss = "jy-bot"; break;
                case 9: jamss = "jy-bot"; break;
                case 10: jamss = "jy-bot"; break;
                case 11: jamss = "jy-bot"; break;
                case 12: jamss = "jy-bot"; break;
                case 13: jamss = "jy-bot"; break;
                case 14: jamss = "jy-bot"; break;
                case 15: jamss = "jy-bot"; break;
                case 16: jamss = "jy-bot"; break;
                case 17: jamss = "jy-bot"; break;
                case 18: jamss = "jy-bot"; break;
                case 19: jamss = "jy-bot"; break;
                case 20: jamss = "jy-bot"; break;
                case 21: jamss = "jy-bot"; break;
                case 22: jamss = "jy-bot"; break;
                case 23: jamss = "jy-bot"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*jy-bot*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `jy-bot`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/51957947127`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*jy-bot*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://github.com/JYBriggitt')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel')
}
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `jy-bot Script`,
          "url": "https://github.com/JYBriggitt/jy-bot"
        },
        "index": 0
      }
    ]
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`jy-bot`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY jy-bot`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `jy-bot`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `jy-bot`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
